namespace Web.DreamHome.Controllers
{
    ...
    {
        public ActionResult Crear(int _idCliente)
        {
            ViewBag.IDF_CLIENTE_RQRM = _idCliente;
        ...
        public ActionResult Crear(RequerimientosClientesDTO requerimientosClientesDTO)
        {
            ...
            return RedirectToAction("Inicial", "Clientes", new { _mensaje = new RequerimientosClientesRepositorio().ValidarRequerimientosCliente(requerimientosClientesDTO) });
        }
        ...
        public ActionResult Editar(RequerimientosClientesDTO requerimientosClientesDTO)
        {
            ...
            ViewBag.IDF_ESTADO_RQRM = new SelectList(new ListasRepositorio().ConsultarEstadosRequerimiento(), "ID_ESTADO_REQUERIMIENTO", "ESTADO_REQUERIMIENTO", requerimientosClientesDTO.IDF_ESTADO_RQRM);
            requerimientosClientesDTO.SESSION = GetSession();
            return RedirectToAction("Inicial", "Clientes", new { _mensaje = new RequerimientosClientesRepositorio().ActualizarRequerimientosCliente(requerimientosClientesDTO) });
        }

        public ActionResult Eliminar(int _id)
        {
            return RedirectToAction("Inicial", "Clientes", new { _mensaje = new RequerimientosClientesRepositorio().EliminarRequerimientosCliente(new RequerimientosClientesDTO { ID_REQUERIMIENTO = _id, SESSION = GetSession() }) });
        }
